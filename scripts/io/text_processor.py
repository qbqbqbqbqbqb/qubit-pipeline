...
class TextProcessor:
    ...
    def trim_to_last_sentence(text: str) -> str:
        ...
        try:
            ...
            logger.error(f"Error trimming to last sentence: {e}")
            return text
    ...
    def limit_sentences(text: str, max_sentences: int=3) -> str:
        ...
        try:
            ...
            logger.error(f"Error limiting sentences: {e}")
            return text
    ...
    def limit_chars(text: str, max_chars: int=300) -> str:
        ...
        try:
            ...
            logger.error(f"Error limiting chars: {e}")
            return text
    ...
    def clean_and_limit_text(text: str,
        ...
        try:
            ...
            logger.error(f"Error cleaning and limiting text: {e}")
            return text
